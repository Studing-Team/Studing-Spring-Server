...
public enum SuccessMessage {
    ...
    FIRST_COME_APPLY_SUCCESS(HttpStatus.CREATED.value(), "선착순 신청이 완료되었습니다."),
    ...
    NOTICE_ALARM_SET_SUCCESS(HttpStatus.OK.value(), "공지사항 알림 설정이 완료되었습니다."),
    FIRST_COME_RANKINGS_FETCH_SUCCESS(HttpStatus.OK.value(), "선착순 순위 조회에 성공하였습니다."),
    ...
    NOTICE_ALARM_CANCEL_SUCCESS(HttpStatus.OK.value(), "공지사항 알림 취소가 완료되었습니다."),
    // SuccessMessage.java에 추가
    PASSWORD_CHANGE_SUCCESS(HttpStatus.OK.value(), "비밀번호가 성공적으로 변경되었습니다."),
    // SuccessMessage에 추가
